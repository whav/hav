...
class CollectionPermissionTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.user3 = User.objects.create(username='user3', is_superuser=True, is_staff=True)
        cls.collection = Collection.objects.create(name='Testcollection', short_name='test')
    ...
    def testOtherPermission(self):
        self.assertFalse(has_collection_permission(self.user1, self.collection), msg='Staff has no collection permissions by default')
