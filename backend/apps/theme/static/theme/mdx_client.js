...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // src/mdx/components/index.js
  var import_react8 = __toModule(require_react());

  // src/mdx/components/media.js
  ...
  // src/mdx/utils/fetcher.js
  var fetcher2 = (...args) => fetch(...args).then((res) => res.json());
  var fetcher_default = fetcher2;

  // src/mdx/components/media.js
  var ImageMedia = ({ title, thumbnail }) => {
    return /* @__PURE__ */ import_react5.default.createElement("img", {
      alt: title,
      src: thumbnail
    });
  };
  var MediaSwitch = (props) => {
    return /* @__PURE__ */ import_react5.default.createElement(ImageMedia, {
      ...props
    });
  };
  var Media = (props) => {
    const { id, caption, sizes, width } = props;
    const { data, error } = esm_default(`/d/api/public/media/${id}/`, fetcher_default);
    if (error)
    ...
    }, caption && /* @__PURE__ */ import_react5.default.createElement("div", null, caption), /* @__PURE__ */ import_react5.default.createElement(MediaSwitch, {
      ...data,
      ...props
    })));
  };
  ...
  // src/mdx/components/folder.js
  var import_react6 = __toModule(require_react());
  var Folder = (props) => {
    const { id } = props;
    return /* @__PURE__ */ import_react6.default.createElement("div", null, "FOLDER");
  };
  var folder_default = Folder;

  // src/mdx/components/Wrapper.js
  ...
  // src/mdx/components/index.js
  var components = {
    HAVMedia: (props) => /* @__PURE__ */ import_react8.default.createElement(media_default, {
      ...props
    }),
    HAVFolder: (props) => /* @__PURE__ */ import_react8.default.createElement(folder_default, {
      ...props
    }),
    Media: (props) => /* @__PURE__ */ import_react8.default.createElement(media_default, {
      ...props
    }),
    wrapper: (props) => /* @__PURE__ */ import_react8.default.createElement(Wrapper_default, {
      ...props
    })
  };
  ...
  function getComponent({ code, frontmatter }) {
    ...
    return /* @__PURE__ */ import_react9.default.createElement(Component, {
      components
    });
  }
  ...
  [...mdxNodes].forEach((e) => {
    const mdxNodes2 = e.querySelectorAll('script[type="custom/mdx"]');
    console.log(mdxNodes2);
    [...mdxNodes2].forEach((node) => {
      ...
      (0, import_react_dom.render)(Component, container);
    });
  });
})();
/*
