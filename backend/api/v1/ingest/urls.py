...
from . import IngestQueueView, IngestQueueDetailView, IngestOptionsView, IngestQueueIngestionView, \
    IngestQueueModifier, SingleIngestView
...
ingest_urls = [
    ...
    path(r'q/<uuid:pk>/ingest/', IngestQueueIngestionView.as_view(), name='ingest_queue_ingest'),
    path(r'q/<uuid:pk>/modify/', IngestQueueModifier.as_view(), name='ingest_queue_modify')
]